...
export interface IItemDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="vaasJHipsterUserPortalApp.item.delete.question" interpolate={{ id: itemEntity.id }}>
