...
public class ItemResourceIntTest {
    ...
    private static final String DEFAULT_CHAIN_ID = "AAAAAAAAAA";
    private static final String UPDATED_CHAIN_ID = "BBBBBBBBBB";
    ...
    public void createItem() throws Exception {
        ...
        assertThat(testItem.getUniqueID()).isEqualTo(DEFAULT_UNIQUE_ID);
        assertThat(testItem.getBrand()).isEqualTo(DEFAULT_BRAND);
        assertThat(testItem.getChainID()).isEqualTo(DEFAULT_CHAIN_ID);
    }
    ...
    public void getAllItems() throws Exception {
        ...
        restItemMockMvc.perform(get("/api/items?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].chainID").value(hasItem(DEFAULT_CHAIN_ID.toString())));
    }
    ...
    public void getItem() throws Exception {
        ...
        restItemMockMvc.perform(get("/api/items/{id}", item.getId()))
            ...
            .andExpect(jsonPath("$.chainID").value(DEFAULT_CHAIN_ID.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateItem() throws Exception {
        ...
        assertThat(testItem.getUniqueID()).isEqualTo(UPDATED_UNIQUE_ID);
        assertThat(testItem.getBrand()).isEqualTo(UPDATED_BRAND);
        assertThat(testItem.getChainID()).isEqualTo(UPDATED_CHAIN_ID);
    }
